...
var Random={
           ...
           checkedNumberAndEmpty:function(a,b)
           {
               if(Active.specialCharActiv==true)
               {
                    ...
                    else if(((this.checkedEmpty(a))&&(this.checkedEmpty(b))))
                    {
                        ...
                        scope.NumberA=Random.randomLanguage(scope.language); 
                        scope.NumberB=Random.randomLanguage(scope.language);
    ...
    var Pass={
        ...
        genePass:function(a,tab)
        {
            ...
            console.log("dlugosc tablicy: "+tab.length);
          while(i<a)
          { 
            console.log("i: "+i);
            console.log("passssssssssssssssssssssss");
                       ...
                       else if(random>=5)
                       {
                          while(true)
                          {
                              ...
                              if(ran<=arrayCreator.tab[1].ranDifference)
                              {
                                  ...
                                  console.log("to jest wartosc: "+arrayCreator.tab[1].value[0]+" "+ran);
                                  console.log("ran: "+ran);
                                  console.log(arrayCreator.tab[1].value[0]);
                                  var nam=arrayCreator.tab[1].value[0]+ran;
                                  console.log("nam: "+nam);
                                  console.log("type of arrayCreator.tab[1].value[0] "+typeof arrayCreator.tab[1].value[0]);
                                  console.log("type of ran "+typeof ran);
  ...
  //    scope.ArrayEmpty();
      scope.scopeArray=[0x0622,0x064A];
      scope.specialChar=[0x0600,0x0649,0x064B,0x06FF];
      var i=0x0600;
      while(i<=0x06FF)
      {
       i++;
 ...
 else
 {
  ...
  //    scope.ArrayEmpty();
      scope.scopeArray=[[0x3400,0x3FFF]];
      var i=0x3400;
      var str="";
      while(i<=0x3FFF)
      {
